...
class ReviewDataPageController extends ControllerMVC
  ...
  List<List<dynamic>> buildHeaderCsvBody() {
    ...
    row = [
      ...
      invoice?.footer?.currencyType?.code ?? 1,
      invoice?.footer?.exchangeRate ?? "0,00",
      invoice?.footer?.netAmountTaxed ?? "0,00",
      invoice?.footer?.netAmountUntaxed ?? "0,00",
      invoice?.footer?.vat27 ?? "0,00",
      invoice?.footer?.vat21 ?? "0,00",
      invoice?.footer?.vat10_5 ?? "0,00",
      invoice?.footer?.vat5 ?? "0,00",
      invoice?.footer?.vat2_5 ?? "0,00",
      invoice?.footer?.vat0 ?? "0,00",
      invoice?.footer?.subtotal ?? "0,00",
      invoice?.footer?.otherTaxesAmount ?? "0,00",
      invoice?.footer?.total ?? "0,00",
    ];
    data.add(row);
    return data;
  }
